 ...
 * This file demonstrates how to integrate Emberomen with a web frontend
 */

// For React/Vue/Angular applications
export class EmberomenClient {
    ...
    useEffect(() => {
        async function init() {
            try {
                ...
                const contractClient = new EmberomenClient(provider, contractAddress);
